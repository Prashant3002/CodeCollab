      ...
      <style>
        {`
          ...
          .progress-chart {
            ...
            height: 150px;
            border-radius: 50%;
            background: conic-gradient(#00c2ff 0deg, #00c2ff 270deg, #e9ecef 270deg, #e9ecef 360deg);
            display: flex;
            align-items: center;
        ...
        <div className="p-4">
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Section 3: AI Insights & Recent Activity */}
              <div className="row g-4">
                {/* AI Insights */}
                <div className="col-lg-6">
                  <div className="ai-insight-card">
                    ...
                    <p className="mb-4">
                      AI will summarize your team's performance and suggest improvements based on project data, task completion rates, and collaboration patterns.
                    </p>
                    <div className="alert alert-light text-dark" role="alert">
                      <i className="bi bi-lightbulb me-2"></i>
                      <strong>Coming Soon:</strong> Personalized recommendations and performance insights powered by AI.
                    </div>
                  </div>
                </div>
                      ...
                      {analyticsData.recentActivity.map((activity, index) => (
                        <div key={index} className="activity-item">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <div className="text-muted small">{activity.project}</div>
