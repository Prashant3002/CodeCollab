          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="settings-card">
                ...
                <div className="notification-item">
                  <div className="notification-info">
                    <div className="notification-title">In-app Notifications</div>
                    <div className="notification-description">Show notifications within the application</div>
                  </div>
                  <div className="form-check form-switch">
                    <input 
                      className="form-check-input" 
                ...
                <div className="notification-item">
                  <div className="notification-info">
                    <div className="notification-title">Project Updates</div>
                    <div className="notification-description">Get notified when projects are updated</div>
                  </div>
                  <div className="form-check form-switch">
                    <input 
                      className="form-check-input" 
                ...
                <div className="notification-item">
                  <div className="notification-info">
                    <div className="notification-title">Task Reminders</div>
                    <div className="notification-description">Receive reminders for upcoming task deadlines</div>
                  </div>
                  <div className="form-check form-switch">
                    <input 
                      className="form-check-input" 
                ...
                <div className="notification-item">
                  <div className="notification-info">
                    ...
                    <div className="notification-description">Get a weekly summary of your projects and tasks</div>
                  </div>
                  <div className="form-check form-switch">
                    <input 
                      className="form-check-input" 
                ...
                <div className="notification-item">
                  <div className="notification-info">
                    ...
                    <div className="notification-description">Important security and account notifications</div>
                  </div>
                  <div className="form-check form-switch">
                    <input 
                      className="form-check-input" 
              ...
              <div className="danger-zone">
                ...
                <button 
                  ...
                  disabled
                  title="This feature is disabled in the demo"
                >
